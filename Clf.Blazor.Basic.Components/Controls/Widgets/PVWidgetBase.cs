...
namespace Clf.Blazor.Basic.Components.Controls.Widgets
{
    public class PVWidgetBase : WidgetBase
    {
        ...
        public Convergence.IO.EPICS.CA.EventCallbackDelegate.ConnectCallback? OnConnectionChanged;
        ...
        public async Task<EndPointID?> TaskGetConnectionToPVValue()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<int> TaskGetPrecision()
        {
            int precision = 0;
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<float> TaskGetConnectionToPVHihi()
        {
            float hihi = 0;
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<float> TaskGetConnectionToPVHigh()
        {
            float high = 0;
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<float> TaskGetConnectionToPVLolo()
        {
            float lolo = 0;
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<float> TaskGetConnectionToPVLow()
        {
            float low = 0;
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<float> TaskGetConnectionToPVHOPR()
        {
            float hopr = 0;
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<float> TaskGetConnectionToPVLOPR()
        {
            float lopr = 0;
            var endpoint = new EndPointID(Protocols.EPICS_CA, PVName + ".HOPR");
            var epicsSettings = new Convergence.IO.EPICS.CA.Settings(
